          ...
          <div class="search-wrapper">
            <div class="search-box">
              ...
              <input
                ...
                :value="searchQuery"
                class="search-input"
                placeholder="Search by name, CNIC, phone number, or address..."
              />
            </div>
          </div>
        </div>
        ...
        <div class="table-body">
          <div v-for="customer in paginatedCustomers" :key="customer.id" class="table-row">
            ...
            <div class="actions-cell">
              <router-link
                :to="`/dashboard/add-guarantor?customer_id=${customer.id}`"
                class="action-button add-guarantor"
              >
...
const fetchAllData = async () => {
  const response = await store.dispatch('customerStore/getCustomersWithoutGuarantors')
  if (response.success) {
...
.action-button.add-guarantor:hover {
